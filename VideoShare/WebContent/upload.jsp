...
<html>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/js/jquery-2.1.1.min.js"></script>
  	<script>
      	...
      	function getUploadMeter(){ 
   		$.post("/getUploadPercentage.do",function(data){ 
	...
	%>
		<h1>视频上传</h1>
		<form action="upload.do" method="post" enctype="multipart/form-data" onsubmit="beginUpload()" target="_self">
			<p>
			<tr>
		        <td>标题（最大50个字符）：</td>
		        <td><input type='text' name='title' value='${param.title}' size='50' maxlength='50'></td>
	        </tr>		
	        <tr>
		        <td>描述（最大200个字符）：</td>
		        <td><textarea cols='60' rows='6' name='description'>${ requestScope.description }</textarea></td>      
	        </tr><br>		
			upload video: <input type="file" name="video" /><br>
