<%@ page pageEncoding="UTF-8" 
	import="java.util.*, java.text.*, videoshare.model.UserService, videoshare.model.Video"%>
...
<html>
	...
	<div class="container">
  		<div class="header">
			...
			<div class="userBar">
			<h1>Home</h1>
		<form method="post" action="searchservlet.do">
			<tr>
		...
		%>
			<a href='user/${ sessionScope.login }'>个人主页</a>
		...
		<%
			...
			List<Video> newest = ((UserService) getServletContext().getAttribute("userService")).getNewestVideos();
			
			if (newest != null) {
			for (Video video : newest) {
		%>
			
			<a href='getvideo.do?id=<%= video.getId() %>'><%= video.getTitle() %></a><br><br>
			<%-- <tr>
